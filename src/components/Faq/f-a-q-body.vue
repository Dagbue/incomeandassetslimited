  ...
  <div class="alpha">
    ...
    <div class="section-1">
      ...
      <section>
        <details>
          <summary>
            WHAT IS INCOME AND ASSETS LIMITED
          </summary>
          <p>
            Income And Assets Limited is an officially registered company and conducts
        ...
        <details>
          ...
          <p>
            Income And Assets Limited is officially incorporated with the UK
    ...
    <div class="section-1">
      ...
      <section>
        ...
        <details>
          <summary>
            How long do IAL withdrawals take via bank card?
          </summary>
          <p>
            On IAL' side all withdrawal requests are processed instantly. Your withdrawal request is then sent to
    ...
    <div class="section-1">
      ...
      <section>
        <details>
          <summary>
            Is IAL PCI DSS compliant?
          </summary>
          <p>
            IAL is independently audited and meets all PCI DSS (Payment Card Industry Data Security Standard)
        ...
        <details>
          ...
          <p>IAL accounts offer several security types to verify the identity of the account owner and protect
        ...
        <details>
          ...
          <p>
            ...
            passwords, IDs, or IAL security types. IAL reps never ask for such info via text, email, or social
            media. Don't leave your Personal Area unattended, carry out IAL activities outside the Personal Area,
            or transfer funds to unknown accounts. Beware of unknown links and don't share passwords. If you suspect
            fraud, contact IAL immediately via live chat or email. Be cautious of unexpected IAL messages; when
