    ...
    <form class="signUp" @submit.prevent="createUser" >
      <div class="wrapper">
        <div class="headline">
          ...
          <h2>
            Create New <br/> <span class="header-span">Income And Assets Limited</span> <br/> Account
          </h2>
          <p>
          ...
          <div class="signUp">
            ...
            <div class="group">
              ...
              <div class="has-addons">
                ...
                <input v-else type="password"  required="required" v-model="model.password"  class="input-form-1 password"   placeholder="Password"   >
...
<!--            <div v-if="error">{{ error }}</div>-->
            ...
            <div class="create-acc">
              <p class="create-text" style="color: #0f171c;">
...
export default {
  ...
  name: 'RegisterForm',
  components: {TermsBaseModal, BaseButton},
  data() {
    return {
