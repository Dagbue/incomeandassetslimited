    ...
    <form class="logoIn" @submit.prevent="signIn" >
      <div class="wrapper">
        <div class="headline">
          ...
          <h2>
            Sign In With Your <br/> <span class="header-span">Income And Assets Limited</span> <br/> Account
          </h2>
        </div>
        ...
        <div class="form">
          <div class="logoIn">
            <div class="form-group">
              <input type="email" placeholder="Email"  name="email" v-model="model.email"  required/>
            </div>
<!--            <div class="form-group">-->
